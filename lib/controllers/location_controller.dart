...
class LocationController extends GetxController implements GetxService {
  ...
  AddressModel getUserAddress() {
    ...
    try {
      _addressModel =
          AddressModel.fronJson(jsonDecode(locationRepo.getUserAddress()));
    } catch (e) {
      print(e);
    }
  ...
  Future<void> getAddressList() async {
    ...
    if (response.statusCode == 200) {
      ...
      response.body.forEach((address) {
        _addressList.add(AddressModel.fronJson(address));
        _allAddressList.add(AddressModel.fronJson(address));
      });
    } else {
      _addressList = [];
      _allAddressList = [];
