...
class AppColors {
  ...
  static final Color mainColor = const Color(0xFF2B2B68);
  //static final Color mainColor = const Color (0xFFfa7552) ;
  static final Color iconColor1 = const Color(0xFFFF5330);
  static final Color iconColor2 = const Color(0xFFFF5330);
  ...
  static final Color yellowColor = const Color(0xFFFF5330);
  static final Color amberAccent = const Color(0xFFFF5330);
}
